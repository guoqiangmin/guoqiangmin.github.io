export const IconThreejs = ({ width = 64, height = 64, color = '#fff' }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="27 26 173.23 174.94" fill="none">
      <g stroke={color} strokeWidth="4" strokeMiterlimit="10" strokeLinejoin="round">
